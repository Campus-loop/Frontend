          ...
          <div className="relative">
            ...
            <table className="hidden w-full lg:table filterTable">
              <tbody className="[&>tr]:border-b [&>tr]:border-jnGray-300">
                ...
                {/* only show when it is open */}
                {open ? (<tr>
                  <td className="no-border"></td>
                  <td className="!py-2">
                    <ul className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-2 text-sm">
                      <li>
                        <a className="block p-2 hover:text-blue-600" href="/search?category=101&page=1">Books</a>
                      </li>
                      <li>
                        <a className="block p-2 hover:text-blue-600" href="/search?category=102&page=1">Electronics</a>
                      </li>
                    </ul>
                  </td>
                </tr>) : ""
