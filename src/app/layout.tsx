...
import '../public/css/campus-loop_2.css'
                ...
                <div className="text-xs leading-[14.32px] text-jnGray-600 px-5 xl:px-0 mx-auto mt-8 mb-10 xl:mt-10 xl:mb-11 max-w-[1024px] min-[1600px]:max-w-[1280px]">
                    <section className="flex flex-col justify-between md:flex-row">
                        <div className="mb-6 md:mb-0">
                            <h4 className="mb-3 font-bold text-jnGray-900">
                                (주)중고나라{/* */} 사업자 정보
                            </h4>
                            <ul className="[&>li]:mb-2">
                                <li className="flex items-center">
                                    (주)중고나라
                                    <div className="w-[1px] h-2 bg-[#E0E0E0] mx-2" />
                                    대표자 : 최인욱
                                </li>
                                <li>사업자 등록번호 : 215-87-87482</li>
                                <li>통신판매신고번호 : 제2024-서울강남-06966호</li>
                                <li>
                            ...
                            <div className="flex">
                                ...
                                <ul className="flex items-center">
                                    <li>
                                        <a href="https://seller.joonggonara.co.kr/">
                                            중고나라 셀러 회원 신청
                                        </a>
                                    </li>
                                    <div className="w-[1px] h-2 bg-[#E0E0E0] mx-2" />
                        ...
                        <ul className="flex">
                            ...
                            <li className="w-5 h-5 mr-5 last:mr-0 text-jnGray-600">
                                <a
                                    className="[&>*]:w-full [&>*]:h-full"
                                    target="_blank"
                                    href="https://m.blog.naver.com/joonggonara_official/223313152022"
                                >
                                    <svg
                                        width="1em"
                                        height="1em"
                                ...
                                >
                                    ...
                                    >
                                        <g clipPath="url(#circle-gray_svg__a)">
                                            <path fill="#787E89" d="M9 18A9 9 0 1 0 9 0a9 9 0 0 0 0 18" />
                                            <path
                                                fill="#fff"
                        ...
                        <div className="mt-5 lg:mt-0 lg:w-[48%] flex justify-end">
                            <div className="text-xs w-full [&>button]:lg:ml-auto">
                                ...
                                <ul className="grid grid-cols-4 lg:grid-cols-6 min-[1600px]:grid-cols-7 lg:w-fit lg:ml-auto gap-2 invisible">
                                    ...
                                    <li>
                                        <a href="/category/%EC%88%98%EC%9E%85%EB%AA%85%ED%92%88">
                                            수입명품
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/category/%ED%8C%A8%EC%85%98%EC%9D%98%EB%A5%98">
                                            패션의류
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/category/%ED%8C%A8%EC%85%98%EC%9E%A1%ED%99%94">
                                            패션잡화
                                        </a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="/category/%EA%B0%80%EC%A0%84%EC%A0%9C%ED%92%88">
                                            가전제품
                                        </a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="/category/%EB%A6%AC%EB%B9%99-%EC%83%9D%ED%99%9C">
                                            리빙/생활
                                        </a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="/category/%ED%8B%B0%EC%BC%93-%EC%BF%A0%ED%8F%B0">
                                            티켓/쿠폰
                                        </a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="/category/%EB%A0%88%EC%A0%80-%EC%97%AC%ED%96%89">
                                            레저/여행
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/category/%EC%98%A4%ED%86%A0%EB%B0%94%EC%9D%B4">
                                            오토바이
                                        </a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="/category/%EB%AC%B4%EB%A3%8C%EB%82%98%EB%88%94">
                                            무료나눔
                                        </a>
                                    </li>
                                    <li>
